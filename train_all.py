...
all_items = os.listdir(root_directory / "datasets/MVTec")

# 筛选出所有目录
category_list = [item for item in all_items if os.path.isdir(os.path.join(root_directory / "datasets/MVTec", item))]
